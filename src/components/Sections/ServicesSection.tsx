                  ...
                  >
                    ...
                    <div className="flex justify-center w-full py-2">
                      <button
                        ...
                        className="w-full rounded-full text-xl bg-teal text-white hover:bg-white hover:text-black border-2 hover:border-teal uppercase m-4 p-4 transition-all duration-200"
                      >
                        Rezerwuj
                      </button>
                    </div>
